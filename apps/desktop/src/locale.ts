...
export const en = {
  ...
  startupFailed: '鑫哥专属 could not start',
  startupLoading: 'Starting 鑫哥专属…',
  ...
  browserExtensionMenu: 'Chrome Browser Extension…',
  browserExtensionInstall: 'Open official extension store',
  browserExtensionDescription: 'Install the official Playwright extension in Chrome. Ask DS to operate a page, then select and authorize the tab in Chrome. DS uses page controls without macOS Accessibility permission. Only share tabs needed for the task; disconnect in the extension when finished. The extension UI is maintained by Microsoft.',
...
export const zh = {
  application: '应用',
  startupFailed: '鑫哥专属无法启动',
  startupLoading: '正在启动鑫哥专属…',
  ...
  browserExtensionMenu: 'Chrome 浏览器扩展…',
  browserExtensionInstall: '打开官方扩展商店',
  browserExtensionDescription: '在 Chrome 安装官方 Playwright 扩展。向 DS 提出网页操作任务后，在 Chrome 选择标签页并允许连接。DS 直接操作网页控件，不需要 macOS 辅助功能权限。只授权任务所需标签页，用完可在扩展中断开连接。扩展自身界面由微软维护。',
  ...
  updateDetail: '鑫哥专属 {version}\n\n新版本包含匹配的运行环境，安装后将重新启动。',
  installAndRestart: '安装并重启',
  later: '稍后',
  updateFailedTitle: '更新失败',
  pluginManagerTitle: '桌面插件',
  pluginWindowTitle: '鑫哥专属 — 桌面插件',
