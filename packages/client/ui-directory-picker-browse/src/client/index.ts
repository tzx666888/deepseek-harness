  ...
  ctx.effect(() => {
    ...
    const dictionaries: [locale: string, dict: Record<string, string>][] = [
      ['zh', {
        ...
        'browser.directory.applications': '应用程序',
        'browser.directory.desktop': '桌面',
        'browser.directory.documents': '文稿',
        'browser.directory.downloads': '下载',
        'browser.directory.library': '资源库',
        'browser.directory.movies': '影片',
        'browser.directory.music': '音乐',
        'browser.directory.pictures': '图片',
        'browser.directory.public': '公共',
        'browser.directory.sites': '站点',
      }],
      ['en', {
        ...
        'browser.directory.applications': 'Applications',
        'browser.directory.desktop': 'Desktop',
        'browser.directory.documents': 'Documents',
        'browser.directory.downloads': 'Downloads',
        'browser.directory.library': 'Library',
        'browser.directory.movies': 'Movies',
        'browser.directory.music': 'Music',
        'browser.directory.pictures': 'Pictures',
        'browser.directory.public': 'Public',
        'browser.directory.sites': 'Sites',
      }],
    ]
    try {
