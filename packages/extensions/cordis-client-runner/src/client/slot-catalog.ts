...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'main.conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-brand-official LocalPlanetBrandMark',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-brand-official LocalizedBrandName',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    source: 'packages/client/ui-sidebar-documentpreview/src/client/contract/contract.ts:24',
  },
  {
